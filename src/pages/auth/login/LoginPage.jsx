...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex font-sans">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold text-white font-display leading-tight mb-6">
              Build something
              <br />
              <span className="text-violet-200">extraordinary</span>
            </h1>
            ...
            <div className="space-y-4">
              {[
                { icon: Zap, text: 'Instant Preview — see changes in real time' },
                { icon: Sparkles, text: 'AI-Powered — smart customization & generation' },
                { icon: Code2, text: 'Open Source — fully transparent & extensible' },
              ].map(({ icon: Icon, text }) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-slate-50 dark:bg-slate-950 relative">
        {/* Dark mode toggle */}
        <button
          onClick={toggleDark}
            ...
            <CardContent className="p-6 sm:p-8 space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white dark:bg-slate-900 px-3 text-slate-400 dark:text-slate-500 uppercase tracking-wide">or continue with email</span>
                </div>
              </div>
              ...
              <p className="text-center text-sm text-slate-500 dark:text-slate-400">
                ...
                <Link to="/auth/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-semibold">
                  Sign up
                </Link>
              </p>
            </CardContent>
